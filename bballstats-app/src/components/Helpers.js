...
export const DisabledFormMemberStyle = "shadow appearance-none border rounded w-full py-2 px-2 text-gray-700 leading-tight duration-75";
export const DisabledFormMemberStyleNotFull = "shadow appearance-none border rounded py-2 px-2 text-gray-700 leading-tight duration-75";
...
export const ButtonRedStyle = "shadow bg-red-400 mt-2 border rounded py-2 px-3 text-red-700 transition duration-75 hover:bg-red-600 leading-tight focus:outline-none focus:shadow-outline";
export const ButtonStyleForbid = "shadow bg-gray-400 mt-2 border rounded py-2 px-3 text-gray-700 transition duration-75 hover:bg-gray-600 leading-tight focus:outline-none focus:shadow-outline";
export const ButtonNoMtStyle = "shadow bg-blue-400 border rounded py-2 px-3 text-gray-700 transition duration-75 hover:bg-blue-600 leading-tight focus:outline-none focus:shadow-outline";
...
export const RoleMemberStyle = "shadow border max-w-sm bg-white rounded w-full py-2 px-3 text-gray-700 leading-tight duration-75 ";
