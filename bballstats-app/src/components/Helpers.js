...
export const LinkStyle = "shadow max-w-min bg-blue-400 mt-2 border rounded py-2 px-3 text-gray-700 transition duration-75 hover:bg-blue-600 leading-tight focus:outline-none focus:shadow-outline";
...
export const RoleMemberStyle = "shadow border max-w-sm rounded w-full py-2 px-3 text-gray-700 leading-tight duration-75 hover:border-blue-400 focus:outline-none focus:shadow-outline";
