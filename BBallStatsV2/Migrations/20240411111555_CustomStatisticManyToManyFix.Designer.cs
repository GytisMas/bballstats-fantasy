...
namespace BBallStatsV2.Migrations
{
    ...
    [Migration("20240411111555_CustomStatisticManyToManyFix")]
    partial class CustomStatisticManyToManyFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomStatisticRegularStatistic", b =>
                {
                    b.Property<int>("CustomStatisticsId")
                        .HasColumnType("int");

                    b.Property<int>("StatisticsId")
                        .HasColumnType("int");

                    b.HasKey("CustomStatisticsId", "StatisticsId");
            ...
            modelBuilder.Entity("CustomStatisticRegularStatistic", b =>
                {
                    b.HasOne("BBallStats.Data.Entities.CustomStatistic", null)
                        .WithMany()
                        .HasForeignKey("CustomStatisticsId")
